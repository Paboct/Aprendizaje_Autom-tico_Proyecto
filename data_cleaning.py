...
df_preprocessed_1 = data.fillna(mean_delay)
...
category_columns = [col for col in df_preprocessed_1.columns if df_preprocessed_1[col].dtype == 'object']
...
#df_preprocessed_2.drop(columns='Departure Delay in Minutes', inplace=True)
#df_preprocessed_1.drop(columns='id', inplace=True)
#df_preprocessed_2.drop(columns='id', inplace=True)
